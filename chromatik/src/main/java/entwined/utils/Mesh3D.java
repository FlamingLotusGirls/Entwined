...
public interface Mesh3D {
        ...
        /**
         * Adds the given 3 points as triangle face to the mesh. The assumed
        ...
        /**
         * Centers the mesh around the given pivot point (the centroid of its
         * AABB). Method also updates & returns the new bounding box.
         *
         * @param origin new centroid or null (defaults to {0,0,0})
         */
        ...
        /**
         * Changes the vertex order of faces such that their normal is facing
        ...
        /**
         * Flips all vertices along the Y axis and reverses the vertex ordering
         * of all faces to compensate and keep the direction of normals intact.
         *
         * @return itself
         */
